"""Native cognis-connect emit for oscalkit — forward findings to any platform.

Maps oscalkit's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    oscalkit ... --format json | oscalkit-emit --to stix
    oscalkit-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
